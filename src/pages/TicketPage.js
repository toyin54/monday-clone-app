            ...
            <div className="ticket-container">
                <form onSubmit={handleSubmit}>
                    <section>
                        ...
                        <label htmlFor = "new-category" > Title</label>
                        <input
                            id = "new-category"
                            name = "category"
                            type = "text"
                        ...
                        <div
                            className={"mulptile-input-container"}
                        >
                            <input
                            id="priority-1"
                            name="priority"
                        ...
                        >
                            ...
                            <option
                                selected={formData.status === "wip"}
                                value="wip" > WIP</option>
                            <option
                                selected={formData.status === "hold"}
                                value="hold" > On Hold</option>
                            <option
